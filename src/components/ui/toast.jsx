...
const ToastViewport = React.forwardRef((/** @type {ToastViewportProps} */ { className, ...props }, ref) => (
...
const Toast = React.forwardRef(( /** @type {ToastProps} */ { className, variant, children, ...props }, ref) => {
    return (
        <ToastPrimitives.Root
            ref={ref}
            className={cn(toastVariants({ variant }), className)}
            {...props}
        > {children}</ToastPrimitives.Root>
    );
});
Toast.displayName = ToastPrimitives.Root.displayName;

const ToastAction = React.forwardRef(( /** @type {ToastActionProps} */ { className, altText = "Action", ...props }, ref) => (
...
const ToastClose = React.forwardRef(( /** @type {ToastViewportProps} */ { className, ...props }, ref) => (
...
const ToastTitle = React.forwardRef(( /** @type {ToastViewportProps} */ { className, ...props }, ref) => (
...
const ToastDescription = React.forwardRef(( /** @type {ToastViewportProps} */ { className, ...props }, ref) => (
